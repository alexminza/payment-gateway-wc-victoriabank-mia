    ...
    class WC_Gateway_Victoriabank_MIA extends WC_Payment_Gateway
    {
        ...
        public function validate_required_field($key, $value)
        {
            if (empty($value)) {
                ...
                $this->add_error(esc_html(sprintf(__('%1$s field must be set.', 'payment-gateway-wc-victoriabank-mia'), $this->get_settings_field_label($key))));
            }
        ...
        protected function get_order_description(\WC_Order $order)
        {
            ...
            return wp_strip_all_tags(apply_filters('victoriabank_mia_order_description', $description, $order));
        }
